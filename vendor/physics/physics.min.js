...
})(
  {
      ...
      function (require, module, exports) {
        ...
        _.extend(Attraction.prototype, {
          update: function () {
            ...
            var a2bdistanceSquared = Math.max(
              a2b.lengthSquared(),
              this.distanceMinSquared
            );
          ...
          resting: function () {
            ...
            return (
              ...
              (a.fixed && b.fixed) ||
              (a.fixed &&
                b.position.distanceTo(a.position) <= l &&
                b.resting()) ||
            ...
            _.each(
              ...
              function (p, i) {
                if (!p.fixed) {
                  ...
                  p.velocity.set(
                    ov.x + (k2f.x * 0.5 * dt) / p.mass,
                    ov.y + (k2f.y * 0.5 * dt) / p.mass
                  );
                }
              },
              this
            ...
            _.each(
              ...
              function (p, i) {
                if (!p.fixed) {
                  ...
                  p.velocity.set(
                    ov.x + (k3f.x * dt) / p.mass,
                    ov.y + (k3f.y * dt) / p.mass
                  );
                }
              },
              this
            ...
            _.each(
              ...
              function (p, i) {
                ...
                if (!p.fixed) {
                  ...
                  var x =
                    op.x + (dt / 6) * (k1v.x + 2 * k2v.x + 2 * k3v.x + k4v.x);
                  var y =
                    op.y + (dt / 6) * (k1v.y + 2 * k2v.y + 2 * k3v.y + k4v.y);
                  p.position.set(x, y);
                  var ov = this.originalVelocities[i];
                  var k1f = this.k1Forces[i];
                  var k2f = this.k2Forces[i];
                  ...
                  x =
                    ov.x +
                    (dt / (6 * p.mass)) *
                      (k1f.x + 2 * k2f.x + 2 * k3f.x + k4f.x);
                  y =
                    ov.y +
                    (dt / (6 * p.mass)) *
                      (k1f.y + 2 * k2f.y + 2 * k3f.y + k4f.y);
                  p.velocity.set(x, y);
                }
              },
              this
    ...
    3: [
      function (require, module, exports) {
        ...
        _.extend(Particle.prototype, {
          ...
          resting: function () {
            return (
              this.fixed || (this.velocity.isZero() && this.force.isZero())
            );
          },
        });
    ...
    5: [
      function (require, module, exports) {
        ...
        _.extend(Physics, ParticleSystem, { superclass: ParticleSystem });
        _.extend(Physics.prototype, ParticleSystem.prototype, {
          ...
          onEquilibrium: function (func) {
            if (
              _.indexOf(this.equilibriumCallbacks, func) >= 0 ||
              !_.isFunction(func)
            ) {
              return this;
            }
        ...
        function update() {
          ...
          if (
            ((this.__optimized && !this.__equilibrium) || !this.__optimized) &&
            this.playing
          ) {
            raf(function () {
              update.call(_this);
      ...
      { "./ParticleSystem": 4, "./common": 8, "./requestAnimationFrame": 11 },
    ],
    6: [
      function (require, module, exports) {
        var _ = require("./common"),
        ...
        _.extend(Spring.prototype, {
          ...
          resting: function () {
            ...
            return (
              ...
              (a.fixed &&
                (l === 0
                  ? b.position.equals(a.position)
                  : b.position.distanceTo(a.position) <= l) &&
                b.resting()) ||
              (b.fixed &&
                (l === 0
                  ? a.position.equals(b.position)
                  : a.position.distanceTo(b.position) <= l) &&
                a.resting())
            );
          },
        });
...
//# sourceMappingURL=physics.min.map
